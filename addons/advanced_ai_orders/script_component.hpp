...
#define CBA_EVENT_SECURITY_RETURN_TO_VEHICLE QUOTE(TRIPLES(PREFIX,events,securityReturnToVehicle))
...
#define CBA_EVENT_SETTINGS_SET_SECURITY_REFERENCE QUOTE(TRIPLES(PREFIX,events,settingsSetSecurityReference))
