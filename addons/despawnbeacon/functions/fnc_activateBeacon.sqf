...
_this spawn {
    ...
    _beacon setVariable[QGVAR(active), true, true];

    _beacon setVariable["ace_cargo_canLoad", false, true];
    _beacon setVariable["ace_dragging_canCarry", false, true];
    _beacon setVariable["ace_dragging_canDrag", false, true];
    ...
    _marker setMarkerText LLSTRING(MarkerText);

    _beacon setVariable[QGVAR(marker), _marker, true];

    private _uav = createVehicle[QGVAR(I_UAV_01_F), getPosATL _beacon, [], 10, "NONE"];
    TRACE_1(QFUNC(activateBeacon),_uav);
    ...
    _beacon setVariable[QGVAR(UAV), _uav, true];
    ...
    _beacon setVariable[QGVAR(ready), false, true];
    ...
    _beacon setVariable[QGVAR(ready), true, true];
    _beacon setVariable["ace_cargo_canLoad", true, true];
    _beacon setVariable["ace_dragging_canCarry", true, true];
    _beacon setVariable["ace_dragging_canDrag", true, true];
