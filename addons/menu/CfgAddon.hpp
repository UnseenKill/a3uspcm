class GVAR(Config) {
    class Diary {
        class Miscellaneous {
            ...
            class FindIntel {
                ...
                class Intel {
                    ...
                    flags[] = {{"FlagSmall_F","FlagMarker_01_F"},{"ace_marker_flags_red","ace_flags_carrier_red"}};
        ...
        class AAFireControl {
            ...
            class OpenTablet {
                caption = CSTRING(AAFireControl_OpenTabletCaption);
                text = CSTRING(AAFireControl_OpenTabletText);
                action = QFUNCMAIN(aafcOpenTablet);
                cmShortcut = 1;
                closeDiary = 1;
            };
        };
