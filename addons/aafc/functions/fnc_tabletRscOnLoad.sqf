...
CBA_SUBSCRIBE(CBA_EVENT_AAFC_DIALOG_TABSETUP,{call FUNC(tabletTargetsSetup)});
...
CBA_SUBSCRIBE(CBA_EVENT_AAFC_DIALOG_TAB_FOCUS_BEFORE,{call FUNC(tabletTargetsFocus)});
CBA_SUBSCRIBE(CBA_EVENT_AAFC_DIALOG_TAB_FOCUS_AFTER,{call FUNC(tabletEventOnAfterTabFocus)});
CBA_SUBSCRIBE(CBA_EVENT_AAFC_DIALOG_TAB_UNFOCUS_BEFORE,{call FUNC(tabletTargetsUnfocus)});
