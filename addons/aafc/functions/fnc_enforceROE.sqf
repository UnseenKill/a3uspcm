...
private _roeMap = createHashMapFromArray[
    [ROE_HOLDFIRE, []],
    [ROE_FIREATWILL, [AA_TYPE_CIWS, AA_TYPE_SPAAG, AA_TYPE_SRSAM, AA_TYPE_LRSAM]],
    [ROE_CIWSONLY, [AA_TYPE_CIWS]],
    [ROE_SRSAM, [AA_TYPE_CIWS, AA_TYPE_SPAAG, AA_TYPE_SRSAM]],
    [ROE_LRSAM, [AA_TYPE_CIWS, AA_TYPE_SPAAG, AA_TYPE_SRSAM, AA_TYPE_LRSAM]]
];
