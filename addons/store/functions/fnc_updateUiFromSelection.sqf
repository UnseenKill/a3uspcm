...
try {
    ...
    _display displayCtrl IDC_RSCA3USPCMSTORESELLDIALOG_PICTURESELLITEM ctrlSetText getText((_data get "config") >> (_data get "class") >> "picture");
} catch {
    ...
    _display displayCtrl IDC_RSCA3USPCMSTORESELLDIALOG_PICTURESELLITEM ctrlSetText "#(argb,8,8,3)color(0,0,0,0)";
    _display displayCtrl IDC_RSCA3USPCMSTORESELLDIALOG_BTNSELL ctrlEnable false;
};
