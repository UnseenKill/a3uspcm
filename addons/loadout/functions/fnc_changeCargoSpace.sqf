...
[LLSTRING(PromptChangeCargoSpace), str([_vehicle] call FUNCMAIN(utilAceCargoGetCargoSize)), {
    ...
    [
        LLSTRING(PromptChangeCargoSpace),
        format[LLSTRING(HintCargoSizeChangedText), getText(configOf _vehicle >> "displayName"), _size]
